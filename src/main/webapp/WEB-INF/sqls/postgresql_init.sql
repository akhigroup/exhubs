/* 0. initiation */
drop table admission_tickets;
drop sequence admission_tickets_id_seq;
...
create sequence admission_tickets_id_seq
	start with 1
	increment BY 1
	no minvalue
	no maxvalue
...
create table admission_tickets (
	id int not null default nextval('admission_tickets_id_seq'),
